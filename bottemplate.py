...
**-> random**
    **->** When asking the chatbot random <minNumber> <maxNumber> <howMany>, 
           it will give a random number between the two numbers and how many random 
           numbers it generates.
    **->** So, for example, random 0 20 2 gives back 2 random numbers.\n
**-> sum**
...
**-> todo**
    ...
    **->** When asking your bot todo it will give back all todo items.
    **->** The chatbot is limited to 5 todo items.\n
**-> removetodo**
    **->** When asking the chatbot removetodo <number> it should remove the todo item with the given number.\n
**-> set**
    ...
    **->** When asking the chatbot get <term> it will give you back the definition for the term.
    **->** When calling your bot with just set <term> it will remove the item from the dictionary if it exists.
          ''')
